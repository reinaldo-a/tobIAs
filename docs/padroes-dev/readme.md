...
Este diretório é destinado à organização dos padrões de desenvolvimento utilizados neste projeto. Aqui você encontrará diretrizes, boas práticas e convenções que devem ser seguidas para garantir consistência e qualidade no desenvolvimento.

Certifique-se de consultar este material sempre que necessário e contribuir com melhorias quando possível.
